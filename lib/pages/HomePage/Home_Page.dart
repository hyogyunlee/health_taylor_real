                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          Text('QR', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 18)),
                          Expanded(
                              child: StreamBuilder(
                                stream: FirebaseFirestore.instance
                                    .collection('users')
                                          ...
                                          return Padding(
                                            ...
                                            child:  Row(
                                              ...
                                              children: [
                                                ...
                                                Container(color: Colors.grey, height: 100, width: 3,),
                                                GestureDetector(
                                                  onTap: () {
                                                    setState(() {
                                                      _showQrCodeScreen = true;
                                                      qrData = '단백질: ${user['Protein']}g, 크레아틴: ${user['Creatine']}g, 아르기닌: ${user['Arginin']}g, BCAA: ${user['Bcaa']}g';
                                                    });
                                                    print(_showQrCodeScreen);
                                                  },
                                                  child: QrImageView(
